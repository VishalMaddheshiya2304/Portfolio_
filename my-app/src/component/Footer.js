    ...
    <div className="footer">
      <div className="footer-container">
        <div className="left">
          ...
          <div className="email">
            <FaMailBulk size={20} style={{ color: "white", margin: "0 1rem 0 0" }} />
            <p>vishalmaddheshiya864@gmail.com</p>
          </div>
        </div>
        <div className="right">
          <h4>About me</h4>
          <p>"I am a dedicated computer science student with a passion for React development, eager to showcase my skills through my portfolio."</p>
